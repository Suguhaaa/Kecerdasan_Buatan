...
Original file is located at
    https://colab.research.google.com/drive/1bDIbZxIZRftzKkO1uxTX6K_sobmu3ftk
"""
...
class Algoritma_genetika :
	...
	def __init__(self):
		...
		print("_________________________________________________inisialisasi_________________________________________________")
	...
	def evaluasi_chrom(self, chrom, generasi):
		...
		print("Probabilitas Paling Tinggi : {}, Pada kromosom ke {}".format(Probab[Probab.argmax()], str(Probab.argmax())))
